...
#Check for swear words (There are none)
...
swear_wordsdf <-
    ifelse(reviews$token %in% swear_words, 1, 0)

sum(swear_wordsdf)

swear_wordsdf2 <-
    ifelse(reviews$token %in% swear_words2, 1, 0)

sum(swear_wordsdf2)


>>>>>>> e022d7ea68fede7a3e4ea43dd776f1ce6a749f27
```
